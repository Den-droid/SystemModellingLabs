...
public class Main {
    public static void main(String[] args) {
        ...
        Process process1 = new Process(1, 2, ChooseRouteBy.PROBABILITY);
        process1.setMaxqueue(5);
        process1.setName("Process 1");
        process1.setDistribution("exp");

        Process process2 = new Process(1, 2, ChooseRouteBy.PROBABILITY);
        process2.setMaxqueue(5);
        process2.setName("Process 2");
        process2.setDistribution("exp");

        Process process3 = new Process(1, 2, ChooseRouteBy.PROBABILITY);
        ...
        process2.addNextElement(process3, 1.0);
